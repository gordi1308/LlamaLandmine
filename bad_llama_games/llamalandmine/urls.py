...
urlpatterns = patterns('',
                       ...
                       url(r'^send_challenge/$', game_views.send_challenge, name="send_challenge"),
                       url(r'^handle_challenges/$', profile_views.handle_challenges, name="handle_challenges"),
                       ...
                       url(r'^invalid_login/$', views.home, name='invalid'),
